                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header">
                                        <div class="page-header-title">
                                            <h4> Students Of (<?php echo $name ?>) Competition</h4>
                                        </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            ...
                                                            <div class="card-block table-border-style">
                                                                ...
                                                                <?php 
                                                                $no=1;
                                                                $select_comp="select * from competition_students where competition_id ='$get_id'";
                                                                $run_comp=mysqli_query($con,$select_comp);
                                                                $std_count=mysqli_num_rows($run_comp); 
                                                                while($row=mysqli_fetch_array($run_comp))
                                                                {	
                                                                    $com_id=$row['competition_id'];
                                                                ...
                                                                <?php 
                                                                    if($std_count==0)
                                                                    {
                                                                     ...
                                                                     '></i>No Students in This Compitition.</h6><div></center>";
