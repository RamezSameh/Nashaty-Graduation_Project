...
$title="Nashaty | Manage Positions";
session_start();
...
{
    $get_id =  $_GET['aid'];
    $delete_pos="delete from  election_positions where id = '$get_id'";
    $delete_pos_query=mysqli_query($con,$delete_pos);
    if($delete_pos_query)
    {
                            ...
                            <div class="main-body user-profile">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header">
                                        ...
                                        <br><br>
                                        <a href="add_position.php" class="btn btn-success"><i class="icofont icofont-plus"></i> Add Position</a>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            ...
                                                            <div class="card-block table-border-style">
                                                                ...
                                                                <?php 
                                                                $no=1;
                                                                $select_pos="select * from  election_positions";
                                                                $run_pos=mysqli_query($con,$select_pos);
                                                                $pos_count=mysqli_num_rows($run_pos); 
                                                                while($row=mysqli_fetch_array($run_pos))
                                                                {	
                                                                    $id=$row['id'];
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a type="button" name="edit" href="edit_position.php?pid=<?php echo $id ?>" class="btn btn-warning btn-rounded btn-icon">
                                                                                <i class="icofont icofont-ui-edit"></i>
                                                                            </a>                       
                                                                        </td>

                                                                        <td>
                                                                            <a type="button" name="delete" href="manage_positions.php?aid=<?php echo $id?>" class="btn btn-danger btn-rounded btn-icon">
                                                                ...
                                                                <?php 
                                                                    if($pos_count==0)
                                                                    {
                                                                     ...
                                                                     '></i>No Positions in system.</h6><div></center>";
