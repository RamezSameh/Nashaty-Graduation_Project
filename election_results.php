...
if(isset($_GET['eid']) && isset($_GET['pid']))
{
    ...
    $get_ele="select * from `election_votes` where `elec_id`=$get_eid and `pos_id` =$get_pid";
    $run_msg=mysqli_query($con,$get_ele);
    $total_votes=mysqli_num_rows($run_msg); 
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            ...
                                                            <div class="card-block table-border-style">
                                                               ...
                                                               $no=1;
                                                               $query="select full_name , cand_id , count(*) as count_row from `election_votes` , `users` 
                                                               where `elec_id`=$get_eid and `pos_id` =$get_pid and election_votes.cand_id = users.user_id GROUP BY cand_id";
                                                               ...
                                                               {	
                                                                   $count_votes = $row['count_row'];
                                                                   $candidate_votes= $row['cand_id'];
                                                                   $query_="select * from users where user_id='$candidate_votes'";
                                                                   $result_ = mysqli_query($con, $query_);
                                                                   //$count=mysqli_num_rows($result_); 
                                                                   while($row=mysqli_fetch_array($result_))
                                                                   {	
                                                                       $name = $row['full_name'];
                                                                       //$count_votes = $row['count_votes'];
                                                               ...
                                                               ?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo ($count_votes/$total_votes)*100 ?> % </td>
