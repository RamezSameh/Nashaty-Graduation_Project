...
$title="Nashaty | Replay To message";
session_start();
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Replay</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <form action="" method="post" >
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            <div class="post-new-contain row card-block">
                                                                ...
                                                                <div class="col-md-12 col-xs-9">
                                                                    <div class="">
                                                                        Your Replay
                                                                        <textarea  type="textarea" rows="7" name="replay_msg" class="form-control mt-2 mb-3">
                                                                        </textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="post-new-footer b-t-muted p-15">
                                                                ...
                                                                <span>
                                                                    <button name="replay"
                                                                        ...
                                                                        style="display: none;"><i class="f"></i> Send Message
                                                                    </button> 
                                                                </span>                                                         
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php
                                                            ...
                                                            {
                                                                $replay=$_POST['replay_msg'];
                                                                $Insert="INSERT INTO `replies` (`msg_id` , `replay`) VALUES ('$get_id ' , '$replay')";
