                            ...
                            <div class="main-body user-profile">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header">
                                        ...
                                        <br><br>
                                        <a href="add_user.php" class="btn btn-success"><i class="icofont icofont-plus"></i> Add User</a>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            ...
                                                            <div class="card-block table-border-style">
                                                                ...
                                                                <?php 
                                                                $no=1;
                                                                $select_users="select * from users where role_id = '0'";
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <img src="admin/uploads/images/students/<?php echo  $picture ?>" style="width:30px;height:30px">
                
                                                                        </td>
                                                                        <td><?php echo $name ?></td>
                                                                       
                                                                        <td>
                                                                            <span class="badge badge-success"><?php echo 'Level '.$level ?> </span>
                                                                        ...
                                                                        <td>
                                                                            <a type="button" name="delete" href="manage_users.php?uid=<?php echo $id?>" class="btn btn-danger btn-rounded btn-icon">
                                                                ...
                                                                <?php 
                                                                    if($users_count==0)
                                                                    {
                                                                     ...
                                                                     '></i>No users in system.</h6><div></center>";
