...
$title="Nashaty | Edit Compitition";
session_start();
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Edit Compitition</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                    ...
                                                    <form action="" method="post" >
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            <div class="post-new-contain row card-block">
                                                                ...
                                                                <div class="col-md-12 col-xs-9">
                                                                    <div class="">
                                                                        Competition Name
                                                                        <input type="text" name="name" class="form-control mt-2 mb-3"  placeholder="Comptition Name" value="<?php echo $name?>">
                                                                        Activity
                                                                     
                                                                        <select name="activity" class="form-control mt-2 mb-3"  style="padding:5px"  required>
                                                                         
                                                                            <?php 
                                                                              
                                                                              
                                                                                $get_activities="select * from activities";
                                                                                $query_activities=mysqli_query($con,$get_activities);
                                                                        ...
                                                                        Competitors Number 
                                                                        <input type="number" name="number" class="form-control mt-2 mb-3"  placeholder="Comptition Numbers">

                                                                        Start Date       
                                                                        <input type="date" name="start" class="form-control mt-2 mb-3"  value="<?php echo $start ?>" required>

                                                                        End Date       
                                                                        <input type="date" name="end" class="form-control mt-2 mb-3"   value="<?php echo $end ?>" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <?php
                                                            ...
                                                            if(isset($_POST['upd_comp']))
                                                            {
                                                                ...
                                                                $InsertComp="UPDATE `competitions` set  name = '$name', activity ='$activity', status ='$status', number_of_students='$limit', start_date ='$start' , end_date='$end' Where id = '$get_id'";
                                                                $run_insert=mysqli_query($con,$InsertComp);
                                                                if($run_insert)
                                                                {
                                                                    
                                                                    echo "<script>window.open('manage_competition.php','_self')</script>";                                                        
                                                                    // echo'<script>
                                                                    // toastr.options = {
                                                                    // "closeButton": false,
                                                                    // "debug": false,
                                                                    ...
                                                                    // "hideMethod": "fadeOut"
                                                                    // }
                                                                    // Command: toastr["success"]("Competition Updated Successfully.");
                                                                    // </script>';
