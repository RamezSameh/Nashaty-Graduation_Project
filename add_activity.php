                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Add Activity</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <form action="" method="post" >
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            <div class="post-new-contain row card-block">
                                                                ...
                                                                <div class="col-md-12 col-xs-9">
                                                                    <div class="">
                                                                        Activity Name
                                                                        <input type="text" name="name" class="form-control mt-2 mb-3"  placeholder="Activity Name">
                                                        ...
                                                        <?php
                                                            ...
                                                            {
                                                                $name=$_POST['name'];
                                                                $InsertComp="INSERT INTO `activities` (`activity_name`) VALUES ('$name')";
                                                                ...
                                                                //    "hideMethod": "fadeOut"
                                                                //    }
                                                                //    Command: toastr["success"]("Activity added Successfully.");
                                                                //    </script>';
