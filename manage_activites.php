...
{
    $get_id =  $_GET['aid'];
    $delete_act="delete from activities where id = '$get_id'";
    $delete_act_query=mysqli_query($con,$delete_act);
    if($delete_act_query)
    {
        header("location:manage_activites.php");
    }
}
                            ...
                            <div class="main-body user-profile">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header">
                                        ...
                                        <br><br>
                                        <a href="add_activity.php" class="btn btn-success"><i class="icofont icofont-plus"></i> Add Activity</a>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            ...
                                                            <div class="card-block table-border-style">
                                                                ...
                                                                $run_actvs=mysqli_query($con,$select_act);
                                                                $users_count=mysqli_num_rows($run_actvs); 
                                                                while($row=mysqli_fetch_array($run_actvs))
                                                                {	
                                                                    $id=$row['id'];
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $name ?></td>
                                                                        <td>
                                                                            <a type="button" name="edit" href="edit_activity.php?aid=<?php echo $id ?>" class="btn btn-warning btn-rounded btn-icon">
                                                                                <i class="icofont icofont-ui-edit"></i>
                                                                            </a>                       
                                                                        </td>

                                                                        <td>
                                                                            <a type="button" name="delete" href="manage_activites.php?aid=<?php echo $id?>" class="btn btn-danger btn-rounded btn-icon">
                                                                ...
                                                                <?php 
                                                                    if($users_count==0)
                                                                    {
                                                                     ...
                                                                     '></i>No Activities in system.</h6><div></center>";
