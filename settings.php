                            ...
                            <div class="main-body user-profile">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header">
                                        ...
                                        <br><br>
                                        <a href="add_admin.php" class="btn btn-success"><i class="icofont icofont-plus"></i> Add New Admin</a>
                                                        ...
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            <div class="post-new-contain row card-block">
                                                                ...
                                                                <div class="col-md-12 col-xs-9">
                                                                    <div class="">
                                                                        Old Password
                                                                        <input type="password" name="old" class="form-control mt-2 mb-3"  placeholder="Old Password">
                                                                        New Password
                                                                        <input type="password" name="new" class="form-control mt-2 mb-3"  placeholder="New Password">
                                                                        Confirm New Password
                                                                        <input type="password" name="conf" class="form-control mt-2 mb-3"  placeholder="Confirm New Password">
                                                                    </div>
                                                                </div>
                                                            </div>
