...
{
    $msg_id =  $_GET['mid'];
    $delete_msg="DELETE from `replies` where id ='$msg_id'";
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="card bg-white" style="border-radius:16px">
                                                            ...
                                                            <div class="card-block table-border-style">
                                                                ...
                                                                <?php 
                                                                $no=1;
                                                                $select_msg="select * from replies order BY id DESC";
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a type="button" name="delete" href="my_messages.php?mid=<?php echo $id ?>" class="btn btn-danger btn-rounded btn-icon">
                                                                ...
                                                                <?php 
                                                                    if($msg_count==0)
                                                                    {
                                                                     ...
                                                                     '></i>No Messages From Admin.</h6><div></center>";
