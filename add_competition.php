                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Add Compitition</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                    ...
                                                    <form action="" method="post" >
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            <div class="post-new-contain row card-block">
                                                                ...
                                                                <div class="col-md-12 col-xs-9">
                                                                    <div class="">
                                                                        Competition Name
                                                                        <input type="text" name="name" class="form-control mt-2 mb-3"  placeholder="Comptition Name">
                                                                        Activity
                                                                        ...
                                                                        Start Date       
                                                                        <input type="date" name="start" class="form-control mt-2 mb-3"  placeholder="Comptition Name">

                                                                        End Date       
                                                                        <input type="date" name="end" class="form-control mt-2 mb-3"  placeholder="Comptition Name">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <?php
                                                            if(isset($_POST['add_comp']))
                                                            {
                                                                ...
                                                                $InsertComp="INSERT INTO `competitions` (`name`, `activity`, status ,`number_of_students` ,`start_date` , `end_date`) VALUES ('$name','$activity','$status','$number','$start','$end')";
                                                                ...
                                                                //    "hideMethod": "fadeOut"
                                                                //    }
                                                                //    Command: toastr["success"]("Compitition added Successfully.");
                                                                //    </script>';
