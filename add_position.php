                                                ...
                                                <div class="row">
                                                    ...
                                                    <form action="" method="post" >
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            <div class="post-new-contain row card-block">
                                                                ...
                                                                <div class="col-md-12 col-xs-9">
                                                                    <div class="">
                                                                    Position Name
                                                                        <input type="text" name="name" class="form-control mt-2 mb-3"  placeholder="Position Name">
                                                        ...
                                                        <?php
                                                            ...
                                                            {
                                                                $name=$_POST['name'];
                                                                $InsertPos="INSERT INTO `election_positions` (`position`) VALUES ('$name')";
                                                                $run_insert=mysqli_query($con,$InsertPos);
                                                                if($run_insert)
                                                                {
                                                                ...
                                                                //    "hideMethod": "fadeOut"
                                                                //    }
                                                                //    Command: toastr["success"]("Position added Successfully.");
                                                                //    </script>';
