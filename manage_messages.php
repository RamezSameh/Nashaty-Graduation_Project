...
{
    $msg_id =  $_GET['mid'];
    $delete_msg="DELETE from `admin_requests` where request_id ='$msg_id'";
    $delete_msg_query=mysqli_query($con,$delete_msg);
    if($delete_msg_query)
    {  
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Manage Messages</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            ...
                                                            <div class="card-block table-border-style">
                                                                ...
                                                                <?php 
                                                                $no=1;
                                                                $select_msg="select * from admin_requests order BY request_id DESC";
                                                                $run_msg=mysqli_query($con,$select_msg);
                                                                $post_count=mysqli_num_rows($run_msg); 
                                                                ...
                                                                {	
                                                                    ...
                                                                    $select_student="select * from users where user_id='$user_id'";
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a type="button" name="show" href="replay.php?mid=<?php echo $id ?>" class="btn btn-success btn-rounded btn-icon">
                                                                                <i class="ion-paper-airplane"></i>
                                                                            </a>                       
                                                                        </td>
                                                                        <td>
                                                                            <a type="button" name="delete" href="manage_messages.php?mid=<?php echo $id ?>" class="btn btn-danger btn-rounded btn-icon">
                                                                ...
                                                                <?php 
                                                                    if($post_count==0)
                                                                    {
                                                                     ...
                                                                     '></i>No messages From users .</h6><div></center>";
