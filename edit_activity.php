...
{
    $get_id =  $_GET['aid'];
    $get_act="select * from `activities` where id ='$get_id'";
    $get_act_query=mysqli_query($con,$get_act);
    while($row=mysqli_fetch_array($get_act_query))
    {
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Edit Activity</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                    ...
                                                    <form action="" method="post" >
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            <div class="post-new-contain row card-block">
                                                                ...
                                                                <div class="col-md-12 col-xs-9">
                                                                    <div class="">
                                                                        Activity Name
                                                                        <input type="text" name="name" class="form-control mt-2 mb-3"  placeholder="Activity Name" value="<?php echo $activity_name?>">
                                                            ...
                                                            <div class="post-new-footer b-t-muted p-15">
                                                                ...
                                                                <span>
                                                                    <button name="upd_comp"
                                                                        ...
                                                                        style="display: none;"><i class="f"></i> Save Activity
                                                                    </button> 
                                                                </span>                                                         
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php
                                                            ...
                                                            if(isset($_POST['upd_comp']))
                                                            {
                                                                ...
                                                                $update_acticity="UPDATE `activities` set  activity_name = '$name' Where id = '$get_id'";
                                                                $run_update=mysqli_query($con,$update_acticity);
                                                                if($run_update)
                                                                {
                                                                    
                                                                    echo "<script>window.open('manage_activites.php','_self')</script>";     
