                                                    ...
                                                    <form action="" method="post" enctype="multipart/form-data">
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            <div class="post-new-contain row card-block">
                                                                ...
                                                                <div class="col-md-11 col-xs-9">
                                                                    <div class="">
                                                                        Post Contect
                                                                        <textarea type="text" name="post_title" class="form-control mt-2 mb-3" rows="3" placeholder="Please Write Usefull Post ....."><?php echo $content ?></textarea>
                                                                        Post Type
                                                                        <select name="post_type" class="form-control mt-2 mb-3" style="padding:5px" required>
                                                                        ...
                                                                        <?php if($_SESSION['role']==1)
                                                                        {
                                                                            echo'
                                                                            Post Level
                                                                            <select name="post_level" class="form-control mt-2 mb-3" style="padding:5px" required>
                                                                        ...
                                                                        Picture
                                                                        <input id="file-input" class="form-control mt-2 mb-3" name="img" type="file"
                                                        ...
                                                        <?php
                                                            if(isset($_POST['update_post']))
                                                            {
                                                                ...
                                                                if($_SESSION['role']==1)
                                                                {
                                                                    $UpdatePost="UPDATE `post` SET post_about = '$type' , content = '$title' , picture = '$img' where post_id = '$get_id'";
                                                                }
                                                                else
                                                                {
                                                                    $UpdatePost="UPDATE `post` SET post_about = '$type' , post_level ='$level', content = '$title' , picture = '$img' where post_id = '$get_id'";
                                                                }
                                                               
                                                                $run_update=mysqli_query($con,$UpdatePost);
                                                                if($run_update)
                                                                {
                                                                   ...
                                                                   Command: toastr["success"]("Post Updated Successfully.");
                                                                   </script>';
