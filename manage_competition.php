...
$title="Nashaty | Manage Activities";
session_start();
...
{
    $get_comp =  $_GET['cid'];
    $delete_comp="DELETE from `competitions` where id ='$get_comp'";
    $delete_comp_query=mysqli_query($con,$delete_comp);
    if($delete_comp_query)
    {  
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header">
                                        <div class="page-header-title">
                                            <h4>Manage Competition</h4>
                                        </div>
                                        <br><br>
                                        <a href="add_competition.php" class="btn btn-success"><i class="icofont icofont-plus"></i> Add Competition</a>
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Competition</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            ...
                                                            <div class="card-block table-border-style">
                                                                ...
                                                                <?php 
                                                                $no=1;
                                                                $select_comp="select * from competitions  order BY id DESC";
                                                                $run_comp=mysqli_query($con,$select_comp);
                                                                $comp_cout=mysqli_num_rows($run_comp); 
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a type="button" name="show" href="competition_students.php?cid=<?php echo $id ?>" class="btn btn-success btn-rounded btn-icon">
                                                                        ...
                                                                        <td>
                                                                            <a type="button" name="edit" href="edit_competition.php?id=<?php echo $id ?>" class="btn btn-warning btn-rounded btn-icon">
                                                                                <i class="icofont icofont-ui-edit"></i>
                                                                            </a>                       
                                                                        </td>

                                                                        <td>
                                                                            <a type="button" name="delete" href="manage_competition.php?cid=<?php echo $id ?>" class="btn btn-danger btn-rounded btn-icon">
                                                                ...
                                                                <?php 
                                                                    if($comp_cout==0)
                                                                    {
                                                                     ...
                                                                     '></i>No Competitions Added  .</h6><div></center>";
