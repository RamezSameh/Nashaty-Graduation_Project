...
$title="Nashaty | Join Competiotion";
session_start();
...
{
    $get_id =  $_GET['cid'];
    $get_comp="select * from `competitions` where id ='$get_id'";
    $get_comp_query=mysqli_query($con,$get_comp);
    while($row=mysqli_fetch_array($get_comp_query))
    {
        $name = $row['name'];
        ...
        $end   = $row['end_date'];
        $no_std =  $row['number_of_students'];
    }
    
    $get_comp_students="select * from `competition_students` where competition_id ='$get_id'";
    $get_comp_students_query=mysqli_query($con,$get_comp_students);
    $comp_students_count=mysqli_num_rows($get_comp_students_query);
                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body user-profile">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Competition Students</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <?php 
                                    $check="select * from competition_students where student_id='$user_id' AND competition_id ='$get_id'";
                                    $result_check = mysqli_query($con, $check);
                                    $count_rec=mysqli_num_rows($result_check);
                                    if($count_rec == 1)
                                    {
                                        $joined = 'is_joined';
                                    }
                                    ...
                                    <?php if ($comp_students_count != $no_std)
                                    {
                                    ?>
                                    <div class="page-body">
                                        <div class="row">
                                                    ...
                                                    <form action="" method="post" enctype="multipart/form-data">
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            <div class="post-new-contain row card-block">
                                                                ...
                                                                <?php if($joined=='not_joined')
                                                                {
                                                                ?>
                                                                <div class="col-md-11 col-xs-9">
                                                                    <div class="">
                                                                        Hey , <h5><?php echo  $user_name ?></h5><br><br>
                                                                        You Are about to Join ( <b><?php echo $activity.' '.$name ?></b> ) <br> That Starts <b> <?php echo $start ?> </b> <br> And Ends with <b><?php echo $end ?></b>
                                                                    </div>
                                                                </div>
                                                                <?php 
                                                                }
                                                                ...
                                                                ?>
                                                                 <div class="col-md-11 col-xs-9">
                                                                    <div class="">
                                                                        <h5><?php echo  $user_name ?></h5><br><br>
                                                                        <h5 style="text-transform:none"> You Joined ( <b><?php echo $activity.' '.$name ?></b> ) Before <br> <br> That Starts <b> <?php echo $start ?> </b><br><br> And Ends with <b><?php echo $end ?></b> <br><br> Be Sure You Are ready<h5>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="post-new-footer b-t-muted p-15">
                                                                <a href="competitions.php" class="mt-3" > Back to Compititions</a>
                                                                <?php if($joined=='not_joined')
                                                                {
                                                                ?>
                                                                <span>
                                                                    <button name="confirm"
                                                                        ...
                                                                        style="display: none;"><i class="f"></i> Confirm Join
                                                                    </button> 
                                                                </span>
                                                                  <?php
                                                                }  
                                                        ...
                                                        {
                                                            $student_id=$user_id;
                                                            $compitition_id=$get_id;
                                                            $InsertStudent="INSERT INTO `competition_students` (`competition_id`, `student_id`) VALUES ('$compitition_id','$student_id')";
                                                            ...
                                                            if($run_insert)
                                                            {
                                                                ...
                                                                //  </script>';
                                                                echo "<script>window.open('competitions.php','_self')</script>";
                                ...
                                else
                                {
                                     ...
                                     '></i>Sorry Limit of Competetors is $no_std , You can check other competitiions.</h6><div></center>";
