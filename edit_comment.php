...
{
    $get_id =  $_GET['id'];
    $get_comment="select * from `post_comment` where com_id ='$get_id'";
    $get_comment_query=mysqli_query($con,$get_comment);
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Edit Comment</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                    ...
                                                    <form action="" method="post" enctype="multipart/form-data">
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            <div class="post-new-contain row card-block">
                                                                ...
                                                                <div class="col-md-11 col-xs-9">
                                                                    <div class="">
                                                                        Comment Contect
                                                                        <textarea type="text" name="comment_title" class="form-control mt-2 mb-3" rows="3" placeholder="Please Write Usefull Post ....."><?php echo $content ?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="post-new-footer b-t-muted p-15">
                                                                ...
                                                                if($_SESSION['role']==1)
                                                                {
                                                                   echo' <a href="admin_timeline.php" class="mt-3" > Back to TimeLine</a>';
                                                                }
                                                                else
                                                                {
                                                                   echo' <a href="student_timeline.php" class="mt-3" > Back to TimeLine</a>';
                                                                }
                                                                ?>
                                                                
                                                                <span>
                                                                    <button name="update_comment"
                                                        ...
                                                        <?php
                                                            if(isset($_POST['update_comment']))
                                                            {
                                                                ...
                                                                $UpdateComment="UPDATE `post_comment` SET  content = '$title'  where com_id = '$get_id'";
                                                                $run_update=mysqli_query($con,$UpdateComment);
                                                                if($run_update)
                                                                {
