...
{
    $get_id =  $_GET['pid'];
    $get_pos="select * from `election_positions` where id ='$get_id'";
    $get_pos_query=mysqli_query($con,$get_pos);
    while($row=mysqli_fetch_array($get_pos_query))
    {
                                                    ...
                                                    <form action="" method="post" >
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            <div class="post-new-contain row card-block">
                                                                ...
                                                                <div class="col-md-12 col-xs-9">
                                                                    <div class="">
                                                                        Position Name
                                                                        <input type="text" name="name" class="form-control mt-2 mb-3"  placeholder="Position Name" value="<?php echo $pos_name?>">
                                                                        
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="post-new-footer b-t-muted p-15">
                                                                <a href="manage_positions.php" class="mt-3" > Back to Positions</a>
                                                                <span>
                                                                    <button name="upd_comp"
                                                                        ...
                                                                        style="display: none;"><i class="f"></i> Save Position
                                                                    </button> 
                                                                </span>                                                         
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php
                                                            ...
                                                            if(isset($_POST['upd_comp']))
                                                            {
                                                                ...
                                                                $update_acticity="UPDATE `election_positions` set  position = '$name' Where id = '$get_id'";
                                                                $run_update=mysqli_query($con,$update_acticity);
                                                                if($run_update)
                                                                {
                                                                    
                                                                    echo "<script>window.open('manage_positions.php','_self')</script>";
