                                            ...
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                                ...
                                                                <?php 
                                                                $no=1;
                                                                $select_elections="select * from elections  order BY id DESC";
                                                                $run_elec=mysqli_query($con,$select_elections);
                                                                $post_comment_cout=mysqli_num_rows($run_elec); 
                                                                ...
                                                                <div class="col-md-6 col-xl-4">
                                                                    <a href="join_election.php?eid=<?php echo  $id ?>" style="color:black">
                                                                        <div class="card widget-profile-card-2">
                                                                        <img class="img-fluid" src="admin/uploads/images/elections/fci.jpg" alt="Election Logo">
                                                                        <div class="card-block text-center">
                                                                        <h4><?php echo $name ?></h4>
                                                                        <p> <i class="icofont icofont-users"></i> <?php echo  'Level - '.$level ?> &nbsp;
                                                                       
                                                                        <hr>
                                                                        <p><?php echo $status.'<br> From '.$start.' <br> To '.$end ?>  </p>
                                                                        </div>
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                                    ...
                                                                    if($post_comment_cout==0)
                                                                    {
                                                                        echo"<br><br><center><div class='alert alert-danger'><h6><i class='mdi mdi-alert
                                                                        '></i>No Elections Now , Please Wait</h6><div></center>";
                                                                    }
                                                               ?>
