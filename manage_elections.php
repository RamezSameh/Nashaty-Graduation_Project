...
$title="Nashaty | Manage Elections";
session_start();
...
if(isset($_GET['eid']))
{
    $get_election =  $_GET['eid'];
    $delete_election="DELETE from `elections` where id ='$get_election'";
    $delete_election_query=mysqli_query($con,$delete_election);
    if($delete_election_query)
    {  
                            ...
                            <div class="main-body user-profile">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header">
                                        ...
                                        <br><br>
                                        <a href="add_election.php" class="btn btn-success"><i class="icofont icofont-plus"></i> Add Election</a> &nbsp;
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Manage Elections</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            ...
                                                            <div class="card-block table-border-style">
                                                                ...
                                                                <?php 
                                                                $no=1;
                                                                $select_elec="select * from elections  order BY id DESC";
                                                                $run_elec=mysqli_query($con,$select_elec);
                                                                $comp_cout=mysqli_num_rows($run_elec); 
                                                                while($row=mysqli_fetch_array($run_elec))
                                                                {	
                                                                    $id=$row['id'];
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo '<span class="badge badge-primary">'.$level.' </span>' ?></td>
                                                                        <td>
                                                                            <?php if($status=="pending")   echo '<span class="badge badge-warning">'.$status.' </span>' ?>
                                                                            <?php if($status=="active")   echo '<span class="badge badge-success">'.$status.' </span>' ?>
                                                                            <?php if($status=="ended") echo '<span class="badge badge-danger">'.$status.' </span>' ?>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <a type="button" name="edit" href="election_students.php?eid=<?php echo $id ?>" class="btn btn-warning btn-rounded btn-icon">
                                                                                <i class="icofont icofont-eye-alt"></i>
                                                                            </a>                       
                                                                        </td>

                                                                        <td>
                                                                            <a type="button" name="edit" href="edit_election.php?id=<?php echo $id ?>" class="btn btn-primary btn-rounded btn-icon">
                                                                                <i class="icofont icofont-ui-edit"></i>
                                                                            </a>                       
                                                                        </td>

                                                                        <td>
                                                                            <a type="button" name="delete" href="manage_elections.php?eid=<?php echo $id ?>" class="btn btn-danger btn-rounded btn-icon">
                                                                ...
                                                                <?php 
                                                                    if($comp_cout==0)
                                                                    {
                                                                     ...
                                                                     '></i>No Elections Added.</h6><div></center>";
