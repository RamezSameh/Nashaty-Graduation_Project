                                                    ...
                                                    <form action="" method="post" enctype="multipart/form-data" >
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            <div class="post-new-contain row card-block">
                                                                ...
                                                                <div class="col-md-12 col-xs-9">
                                                                    <div class="">
                                                                         Name
                                                                        <input type="text" name="name" class="form-control mt-2 mb-3"  placeholder=" Name" required>
                                                                        
                                                                         Email
                                                                        <input type="email" name="email" class="form-control mt-2 mb-3"  placeholder=" Email" required>
                                                                        
                                                                          
                                                                         Password
                                                                        <input type="password" name="pass" class="form-control mt-2 mb-3"  placeholder=" Password" required>
                                                                        
                                                                         Phone
                                                                        <input type="number" name="phone" class="form-control mt-2 mb-3"  placeholder=" Phone" required>
                                                                        ...
                                                                        Gender
                                                                        <select name="gender" class="form-control mt-2 mb-3"  style="padding:5px"  required>
                                                            ...
                                                            <div class="post-new-footer b-t-muted p-15">
                                                                ...
                                                                <span>
                                                                    <button name="register" type="submit"
                                                                        ...
                                                                        style="display: none;"><i class="f"></i> Save User
                                                                    </button> 
                                                                </span>                                                         
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php
                                                            if(isset($_POST['register']))
                                                            {
                                                                ...
                                                                $InsertStudent="INSERT INTO `users` (`full_name`, `gender` ,`profile_picture`, `phone` , `level`, `email` , `password`) VALUES ('$full_name','$gender','$img','$phone','$level','$email','$password')";
                                                                ...
                                                                //    "hideMethod": "fadeOut"
                                                                //    }
                                                                //    Command: toastr["success"]("User added Successfully.");
                                                                //    </script>';
