...
else 
{
    ...
    $admin_photo =  $_SESSION["admin_pic"];
}
                        ...
                        <div>
                            ...
                            <ul class="nav-right">
                                ...
                                <li class="user-profile header-notification">
                                    <a href="">
                                        <img src="admin/uploads/images/students/<?php echo $admin_photo ?>" alt="User-Profile-Image">
                        ...
                        <div class="pcoded-inner-navbar main-menu" style="background-color:#3C4FB1">
                            <div class="">
                                <div class="main-menu-header" style="background-color: #596BC7">
                                    <img class="img-40" src="admin/uploads/images/students/<?php echo $admin_photo ?>" alt="User-Profile-Image">
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            <div class="col-lg-9">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                    <form action="admin_timeline.php" method="post" enctype="multipart/form-data">
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            <div class="post-new-contain row card-block">
                                                                <div class="col-md-1 col-xs-3 post-profile">
                                                                    <img src="admin/uploads/images/students/<?php echo $admin_photo ?>"
                                                                ...
                                                                <div class="col-md-11 col-xs-9">
                                                                    <div class="">
                                                                        <textarea id="post-message" name="post_title"
                                                                            ...
                                                                            placeholder="Please Write Post ....."></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="post-new-footer b-t-muted p-15">
                                                                ...
                                                                <select name="post_type" class="form-control-default" style="padding:5px" required>
                                                                   ...
                                                                   <option value="Anouncment">Anouncment</option>
                                                                   <option value="Anouncment">Activity</option>
                                                                </select>

                                                                &nbsp;&nbsp;&nbsp;
                                                                <select name="post_level" class="form-control-default" style="padding:5px" required>
                                                        ...
                                                        <?php
                                                            if(isset($_POST['addPost']))
                                                            {
                                                                ...
                                                                $InsertPost="INSERT INTO `post` (`user_id`, `writer_name`,`post_level`, `post_about`, `content` , `picture`) VALUES ('$admin_id','$admin_name','$level','$type','$title' , '$img')";
                                                        ...
                                                        <div>
                                                            <div class="bg-white p-relative"
                                                                ...
                                                                <div class="input-group wall-elips">
                                                                    <span
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right b-none services-list">
                                                                            ...
                                                                            <a class="dropdown-item" href="admin_timeline.php?id='.$post_id.'">Delete Post</a>          
                                                                        </div>';
                                                                        ?>
                                                                ...
                                                                <div class="card-block b-b-theme b-t-theme social-msg">
                                                                    <form action="admin_timeline.php" method="POST">
                                                                    ...
                                                                    <button type="submit" name="reactsub" style="border:none;background:none ; cursor:grab">
                                                                        ...
                                                                        //check if react is already done -> change color to red
                                                                            ...
                                                                            $user_react="select * from post_react where post_id='$post_id' and user_id='$admin_id'";
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        if(isset($_POST['reactsub']))
                                                                        {
                                                                            ...
                                                                            if($user_react_num>0)
                                                                            {
                                                                                ...
                                                                                $deleteReact="delete from post_react where user_id = '$admin_id' and post_id='$post_id'";
                                                                            ...
                                                                            else
                                                                            {
                                                                                ...
                                                                                $InsertReact="INSERT INTO post_react (`post_id`, `user_id`) VALUES ('$post_id','$admin_id')";
                                                                ...
                                                                <div class="card-block user-box">
                                                                    ...
                                                                    <div class="media">
                                                                        <a class="media-left" href="#">
                                                                            <img class="media-object img-circle m-r-20"
                                                                                src="admin/uploads/images/students/<?php echo $admin_photo ?>"
                                                                                alt="Generic placeholder image">
                                                                        </a>
                                                                        <div
                                                                            ...
                                                                            if($comment_writer_id == $admin_id) 
                                                                            {
                                                                                echo '&nbsp;<a href="edit_comment.php?id='.$comment_id.'"><i class="icofont icofont-edit-alt"></i></a>'; 
                                                                                echo '&nbsp;<a href="admin_timeline.php?com_id='.$comment_id.'"><i class="icofont icofont-ui-delete"></i></a>';     
                                                                            }
                                                        ...
                                                        <?php
                                                            if(isset($_POST['addComment']))
                                                            {
                                                                ...
                                                                $pos__id = $_POST['hiidd'];                     
                                                                $InsertComment="INSERT INTO `post_comment` (`post_id`, `user_id`,`comment_writer`, `content`) VALUES ('$pos__id','$admin_id','$admin_name','$comment_content')";
    ...
    <script type="text/javascript">
        document.addEventListener("DOMContentLoaded", function(e) {
            ConveyThis_Initializer.init({
                api_key: "pub_7812b51fa29080a9e1c0a1bcce3d4cc2"
            });
        });
    </script>
    <!-- End ConveyThis code -->                                                        
