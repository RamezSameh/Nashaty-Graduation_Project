                                            ...
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                                ...
                                                                $post_comment_cout=mysqli_num_rows($run_comp); 
                                                                ...
                                                                <div class="col-md-6 col-xl-4">
                                                                    <a href="join_compitition.php?cid=<?php echo  $id ?>" style="color:black">
                                                                        <div class="card widget-profile-card-2">
                                                                        <img class="img-fluid" src="admin/uploads/images/competitions/nashaty.png" alt="Competition Logo">
                                                                        <div class="card-block text-center">
                                                                        <h4><?php echo $name ?></h4>
                                                                        <p> <i class="icofont icofont-award"></i> <?php echo  $activity?> &nbsp;
                                                                       
                                                                        <hr>
                                                                        <p><?php echo $status.' From '.$start.' To '.$end ?>  </p>
                                                                        </div>
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                                    ...
                                                                    if($post_comment_cout==0)
                                                                    {
                                                                        ...
                                                                        '></i>No Competition Now , Please Wait</h6><div></center>";
