                                                    ...
                                                    <form action="" method="post" >
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            <div class="post-new-contain row card-block">
                                                                ...
                                                                <div class="col-md-12 col-xs-9">
                                                                    <div class="">
                                                                        Admin Name
                                                                        <input type="text" name="name" class="form-control mt-2 mb-3"  placeholder="admin Name">
                                                                        Admin Email
                                                                        <input type="email" name="email" class="form-control mt-2 mb-3"  placeholder="admin Email">
                                                                        Admin Password
                                                                        <input type="password" name="pass" class="form-control mt-2 mb-3"  placeholder="admin Password">
                                                            ...
                                                            <div class="post-new-footer b-t-muted p-15">
                                                                ...
                                                                <span>
                                                                    <button name="add_admin"
                                                                        ...
                                                                        style="display: none;"><i class="f"></i> Add Admin
                                                                    </button> 
                                                                </span>                                                         
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php
                                                            if(isset($_POST['add_admin']))
                                                            {
                                                                ...
                                                                $email=$_POST['email'];
                                                                $pass=$_POST['pass'];
                                                                $InsertAdmin="INSERT INTO `users` (`role_id` , `full_name` , `email` , `password`) VALUES ('1','$name' , '$email' , '$pass')";
                                                                $run_insert=mysqli_query($con,$InsertAdmin);
                                                                if($run_insert)
                                                                {
                                                                   ...
                                                                   Command: toastr["success"]("Admin added Successfully.");
                                                                   </script>';
                                                                ...
                                                                {
                                                                    echo "Error Happened While Adding Admin Check Db Connection";
