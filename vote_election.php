...
if(isset($_GET['eid']) && isset($_GET['pid']))
{
    $get_eid =  $_GET['eid'];
    $get_pid =  $_GET['pid'];
    $get_ele="select * from `election_positions` where id ='$get_pid'";
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header">
                                        <div class="page-header-title">
                                            <h4> Vote For <?php echo  $pos_name?> </h4>
                                        </div>
                                    ...
                                    <?php 
                                    $check="select * from election_votes where user_id='$user_id' AND pos_id ='$get_pid' AND elec_id ='$get_eid'";
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="row">
                                                <?php if($voted != 'is_voted') 
                                                {
                                                ?>
                                                <form action="" method="post" >
                                                    <ul>
                                                        <?php 
                                                        $query="select * from election_student where election_id='$get_eid' and position_id ='$get_pid'";
                                                        ...
                                                        {	
                                                            ...
                                                            $select_student="select * from users where user_id='$stu_id'";
                                                        ...
                                                        ?>
                                                                ...
                                                                <li style="padding:12px"><input type="radio" name="can_id" value="<?php echo $stu_id ?>">&nbsp;<?php echo $student_name ?></li>
                                                ...
                                                <div class="post-new-footer b-t-muted p-15">
                                                    ...
                                                    <span>
                                                        <button name="vote"
                                                            ...
                                                            class="btn btn-success waves-effect waves-light f-right"
                                                            style="display: none;"><i class="f"></i> Vote 
                                                        </button> 
                                                    </span>
                                                </div>
                                                </form>
                                                ...
                                                else
                                                {
                                                    ...
                                                    ' style='color:green'></i> <h5> You Voted in this election before</h5></div></center>";
                                                ...
                                                {
                                                    $vote = $_POST['can_id'];
                                                    $Insert_Student="INSERT INTO `election_votes` (`user_id`, `cand_id` ,`pos_id` , `elec_id`) VALUES ('$user_id','$vote' , '$get_pid','$get_eid')";
                                                    $run_insert=mysqli_query($con,$Insert_Student);
                                                    if($run_insert)
                                                    {
                                                        echo "<script>window.open('elections.php','_self')</script>";
