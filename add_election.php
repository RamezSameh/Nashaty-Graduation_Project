                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Add Election</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                    ...
                                                    <form action="" method="post" >
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            <div class="post-new-contain row card-block">
                                                                ...
                                                                <div class="col-md-12 col-xs-9">
                                                                    <div class="">
                                                                        Election Name
                                                                        <input type="text" name="name" class="form-control mt-2 mb-3"  placeholder="Election Name">
                                                                        Level
                                                                        ...
                                                                        Start Date       
                                                                        <input type="datetime-local" name="start" class="form-control mt-2 mb-3"  placeholder="Comptition Name">

                                                                        End Date       
                                                                        <input type="datetime-local" name="end" class="form-control mt-2 mb-3"  placeholder="Comptition Name">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <?php
                                                            if(isset($_POST['add_election']))
                                                            {
                                                                ...
                                                                $Insert_election="INSERT INTO `elections` (`election`, `level`, status , `start` , `end`) VALUES ('$name','$level','$status','$start','$end')";
                                                                ...
                                                                //    "hideMethod": "fadeOut"
                                                                //    }
                                                                //    Command: toastr["success"]("Election added Successfully.");
                                                                //    </script>';
