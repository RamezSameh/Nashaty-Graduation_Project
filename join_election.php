                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="row">
                                                        ...
                                                        $query="select * from election_student where election_id='$get_id' group by position_id";
                                                        ...
                                                        {	
                                                            ...
                                                            $query_="select * from election_positions where id='$position'";
                                                        ...
                                                        ?>
                                                            ...
                                                            <div class="col-md-3 col-xl-3">
                                                                <a href="vote_election.php?pid=<?php echo $position ?>&eid=<?php echo $get_id?>">
                                                                    <div class="card widget-profile-card-2">
                                                                        <img class="img-fluid" src="admin/uploads/images/elections/fci.jpg" >
                                                                        <div class="card-block text-center">
                                                                        <i class="icofont icofont-student-alt"></i><h4><?php echo  $position_name  ?></h4>
                                                                        </div>
                                                                    </div>
                                                                </a>
                                                            </div>
