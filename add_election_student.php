                                                    ...
                                                    <form action="" method="post" >
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            <div class="post-new-contain row card-block">
                                                                ...
                                                                <div class="col-md-12 col-xs-9">
                                                                    <div class="">
                                                                        Student ID
                                                                        <select name="id" class="form-control mt-2 mb-3"  style="padding:5px"  required>
                                                                            <option disabled selected> Please Select Student</option>
                                                                            <?php 
                                                                            $get_user="select * from users where role_id='0'";
                                                                        ...
                                                                        Position
                                                                        <select name="position" class="form-control mt-2 mb-3"  style="padding:5px"  required>
                                                                            <option disabled selected> Please Select Position</option>
                                                                            <?php 
                                                                            $get_pos="select * from election_positions";
                                                                            $query_pos=mysqli_query($con,$get_pos);
                                                                            while($row=mysqli_fetch_array($query_pos))
                                                                            {
                                                                                $pos_id=$row['id'];
                                                            ...
                                                            <div class="post-new-footer b-t-muted p-15">
                                                                <a href="election_students.php?eid=<?php echo $get_id ?>" class="mt-3" > Back to Elections Student</a>
                                                                <span>
                                                                    <button name="add_std"
                                                                        style="border-radius:9px;background-color:#3C4FB1;border: none;"
                                                                        class="btn btn-primary waves-effect waves-light f-right"
                                                                        style="display: none;"><i class="f"></i> Add Student
                                                                    </button> 
                                                                </span>                                                         
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php
                                                            if(isset($_POST['add_std']))
                                                            {
                                                                ...
                                                                $Insert_election="INSERT INTO `election_student` (`election_id` , `student_id` , `position_id`) VALUES ('$get_id' , '$student_id' , '$position')";
                                                                $run_insert=mysqli_query($con,$Insert_election);
                                                                if($run_insert)
                                                                {
                                                                    
                                                                    header("location:election_students.php?eid=".$get_id);
                                                                    echo "<script>window.open('election_students.php?eid=$get_id','_self')</script>";
