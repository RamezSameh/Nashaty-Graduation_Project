                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Manage Posts</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="card bg-white" style="border-radius:16px">
                                                            ...
                                                            <div class="card-block table-border-style">
                                                                ...
                                                                <?php 
                                                                $no=1;
                                                                $select_posts="select * from post order BY post_id DESC";
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <?php if( $image ) 
                                                                            echo '<a href="assets/uploads/posts/'.$image.'"><img src="assets/uploads/posts/'.$image.'" style="width:50px;height:50px"></a>';
                                                                            else
                                                                            echo "No image"
                                                                            ?>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <a type="button" name="delete" href="manage_posts.php?pid=<?php echo $id ?>" class="btn btn-danger btn-rounded btn-icon">
                                                                ...
                                                                <?php 
                                                                    if($post_count==0)
                                                                    {
                                                                     ...
                                                                     '></i>No Posts Added Yet.</h6><div></center>";
