                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Ask us</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <form method="post" action="" >
                                                            ...
                                                            <label class="col-sm-2 col-form-label">Subject </label>
                                                                <div class="col-sm-10">                                                         
                                                                <select class="form-control" name="type_inquiry" required>
                                                                
                                                                    <option value="inquiry">inquiry</option>
                                                                    <option value="account">account Problem</option>
                                                                    <option value="compalin">compalin</option>
                                                                </select>
                                                                </div>                                                      
                                                            </div>

                                                            <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Your Inquiry</label>
                                                                <div class="col-sm-10">
                                                                <textarea type="textarea" rows="7" name="inquiry" class="form-control" required></textarea>
                                                                </div>                                                      
                                                            </div>
                                                            <center>                                                      
                                                            <button  type="submit" class="btn btn-info" name="addinquiry" ><i class="ion-paper-airplane"></i> Send Inquiry</button>                                                      
                                                            </center>
                                                        ...
                                                        <?php
                                                            ...
                                                            {
                                                                $type=$_POST['type_inquiry'];
                                                                $inq=$_POST['inquiry'];
                                                                
                                                                $Insertinquiry="INSERT INTO `admin_requests` ( `user_id` , `request_type`, `details`) VALUES ('$user_id','$type','$inq')";
                                                                $run_insert=mysqli_query($con,$Insertinquiry);
                                                                if($run_insert)
                                                                {
                                                                    ...
                                                                    Command: toastr["success"]("Message send Successfully.");
                                                                    </script>';
                                                                    
                                                                }
                                                                else
                                                                {
                                                                echo "<br><center><div class='alert alert-danger'><i class='mdi mdi-alert
